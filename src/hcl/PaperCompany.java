...
import hcl.newyork.NewYorkDistributioncenter;
import hcl.scranton.ScrantonDistrubutionCenter;
...
public class PaperCompany {
	...
	List<Order> orders = new ArrayList<Order>();
	 ...
	 public PaperCompany() {
	        ...
	        distributionCenters.put("scranton", new ScrantonDistrubutionCenter());
	    }
	    ...
	    public void processOrders() {
	        for (Order order : orders) {
	            try {
	                ...
	                ( (ScrantonDistrubutionCenter) distributionCenters.get("scranton"))
